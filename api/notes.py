...
def _create_note_simple(data: dict, raw_text: str):
    ...
    ai_meta = data.get("ai_meta")  # preserve caller-supplied ai_meta even when classify=false
    ...
    if data.get("classify", True) and not explicit_bucket:
        ai_meta = None  # ai_meta only auto-generated by classifier; restore if needed later
